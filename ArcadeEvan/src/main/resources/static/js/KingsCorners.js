    ...
    *************************************************************************************/            
            ...
            function victoryTest(context){
                if(stacks[8].length == 0){
                    ...
                    var victoryObj = new MyCtor(document.getElementById("victoryKC"), "Winner!");
                }
                else if(stacks[0] == 0){
                    won = true;
                    rotateAndPaintImage ( context, loseImage, 0 , 360, 227, 0, 0 );
                    var victoryObj = new MyCtor(document.getElementById("victoryKC"), "Loser...");
                }
            }
            ...
            function endTurn(){
                turns += 1;
                turnsObj.change("Turns Taken: " + turns);
                botMove();
                victoryTest(context);
...
var turnsObj = new MyCtor(document.getElementById("turns"), "Turns Taken: " + turns);
